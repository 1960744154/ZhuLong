...
public class SubjectChildAdapter extends RecyclerView.Adapter<SubjectChildAdapter.ViewHolder> {
    ...
    private com.lhr.zhulong.adapter.SubjectAdapter fatherAdapter;

    public SubjectChildAdapter(List<SpecialtyChooseEntity.DataBean> pData, Context pContext, com.lhr.zhulong.adapter.SubjectAdapter fatherAdapter) {
        data = pData;
        mContext = pContext;
